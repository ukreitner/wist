...
export default function AuctionScreen({ navigation }: NavProps<'Auction'>) {
  ...
  const { playerForSeat, selfName, highestBidText, hand, auctionBids, currentTurn, recentActions, recentlyReceivedCardCodes, submitAuctionBid, submitAuctionPass, error, clearError } = useDemoState();
